...
Public Class Regexconfig
    ...
    Sub Av1a()
        ...
        For Each texbox In Principal.dynamicTxtlist
            ...
            Dim Lines() As String = Principal.dynamicTxtlist(t).Text.Split(Environment.NewLine)
            For Each Line As String In Lines
                ...
                If Regex.IsMatch(Line, TextBoxRegexav1.Text) Then
                    ...
                    Output.AppendLine(Regex.Replace(Line, TextBoxRegexrempav.Text, TextBoxRegexparav.Text))
        ...
        For Each texbox In Principal.dynamicTxtlist
            ...
            For Each Line As String In Lines
                ...
                If Regex.IsMatch(Line, TextBoxRegexav1.Text) Then
                    ...
                    'Regex.Replace effectively splits the text using your searchpattern as the marker for each split
                    Output.AppendLine(Regex.Replace(Line, TextBoxRegexparav.Text, TextBoxRegexrempav.Text))
                    'If there are no SI Values in this row, then just add the row as is to the stringbuilder
                Else : Output.AppendLine(Line)
                End If
            Next Line
